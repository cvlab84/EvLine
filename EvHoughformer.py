...
if __name__ == "__main__":
    from utils import build_hough_bank, make_patch_id_map, hough_embedd_chunk
    ...
    # =========================================================================
    # 🌟 Select Backbone! ('mobilenetv2' or 'resnet50')
    # =========================================================================
    CHOSEN_BACKBONE = 'mobilenetv2' # or 'resnet50'
    ...
    sample_event_map = torch.rand(B, 1, H, W)
    hough_dict = hough_embedd_chunk(sample_event_map, patch_id_map, hbank, num_patches, chunk=1000)
